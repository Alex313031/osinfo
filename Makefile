...
# Compiler flags #
DEFINES  := -DUNICODE -D_UNICODE -D_WINDOWS -DWINVER=0x0500 -D_WIN32_WINNT=0x0500 -D_WIN64_WINNT=0x0502 -D_WIN32_IE=0x501 -DSHARED_OSINFO -DDLL_EXPORT
# Project-specific include dirs
INCLUDE_DIRS = -Ipublic
...
CFLAGS   += -O2 -g0 -s -MMD -MP -mfpmath=sse -mfxsr -msse -msse2 -DNDEBUG -D_NDEBUG -Wunused-function
endif
...
osinfo.def: osinfo.dll
	$(GENDEF) - osinfo.dll > $(PUBLIC_DIR)/osinfo.def
	$(DLLTOOL) -k --output-lib libosinfo.dll.a --def $(PUBLIC_DIR)/osinfo.def
...
# Cleaning Rules #
clean:
	rm -f -v $(DLL_OBJ_C) $(DLL_OBJ_CPP) $(DLL_OBJ_RC) $(DLL_OBJ_C:.o=.d) $(DLL_OBJ_CPP:.o=.d) $(DLL_OBJ_RC:.res=.d) $(TARGET) libosinfo.dll.a
